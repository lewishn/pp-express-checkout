...
<body>
	...
	<div>
		<table border="0" cellpadding="10" cellspacing="0" align="center" class="table">
			<tbody>
				<tr><td><h4>Shipping Address</h5></td><td><h4>Billing Address</h4></td></tr>
				<tr><td>Recipient:</td><td><?php echo $shipToName;		?></td><td><?php echo $shipToName;		?></td></tr>
				<tr><td>Street Address:</td><td><?php echo $shipToStreet;	?></td><td><?php echo $shipToStreet;	?></td></tr>
				<tr><td>City:</td><td><?php echo $shipToCity;		?></td><td><?php echo $shipToCity;		?></td></tr>
				<tr><td>State:</td><td><?php echo $shipToState;	?></td><td><?php echo $shipToState;		?></td></tr>
				<tr><td>Country Code:</td><td><?php echo $shipToCntryCode;?></td><td><?php echo $shipToCntryCode;	?></td></tr>
				<tr><td>Zip Code:</td><td><?php echo $shipToZip;		?></td><td><?php echo $shipToZip;		?></td></tr>
				<tr><td>Total Amount:</td><td>Total Amount:</td><td><?php echo $totalAmt   		?></td></tr>

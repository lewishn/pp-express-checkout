			...
			<div class="container">
	    		...
	    		<table border="0" cellpadding="10" cellspacing="0" align="center" class="table">
	    			...
	    			<h4> <?php echo($firstName); ?>
	    				<?php echo($lastName); ?> , Thank you for your ordering our bricks!</h4>
					...
					<tr><td>
						...
						<?php echo($shipToState) ?>- <?php echo($shipToZip) ?>
					</tr></td>
					<tr><td>
	    			...
	    			<tr><td><a href="./index.php" class="btn btn-primary">Back to main page</a></td></tr>
	    			</div>
	    		</table>
    		</div>
		<?php
